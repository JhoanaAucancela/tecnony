...
import {  updateComprobante } from "../services/AuthService";
...
export default function ModalUpdateComprobante ({isModalOpen, setIsModalOpen, ID}) {
            ...
            {loading == true ? <ActivityLoader /> : null}
                ...
                <Button title="Seleccionar Comprobante" onPress={pickImage} />
                        ...
                        {image && <View>
                            ...
                            <Text>  </Text>
                            <Button title="Guardar Comprobante" onPress={handleSubmit(handleUploadPhoto)} />
                        </View>
                        }
                </View>
            </View>
